    ...
    <footer className="bg-hive-black border-t border-white/10 py-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-12 text-[10px] font-black uppercase tracking-[0.3em] text-white/40">
          ...
          <Link to="/legal#terms" className="hover:text-hive-yellow transition-colors">Terms of Service</Link>
          <Link to="/legal#refund" className="hover:text-hive-yellow transition-colors">Refund Policy</Link>
        </div>
        ...
        <div className="flex flex-col items-center gap-4">
          <p className="text-white/20 text-[10px] font-bold uppercase tracking-widest">
            © 2026 Futsal Hive. Engineered for the Elite.
          </p>
          <Link 
            to="/hive-admin" 
